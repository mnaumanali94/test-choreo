...
public isolated client class Client {
    ...
    public isolated function init(ConnectionConfig config =  {}, string serviceUrl = "http://localhost:3000") returns error? {
    ...
    # 
    #
    resource isolated function patch users() returns http:Response|error {
        string resourcePath = string `/users/${getEncodedUri(userId)}`;
